...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }business-process-other-one.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt crossorigin defer src="${ stRoot }business-process-other-one.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa crossorigin defer src="${ stRoot }business-process-other-one.js"></sc' + 'ript>');
}
	</script>
