...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }official-processing.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }official-processing.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }official-processing.js"></sc' + 'ript>');
}
	</script>
