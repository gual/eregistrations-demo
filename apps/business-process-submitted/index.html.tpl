...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }business-process-submitted.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }business-process-submitted.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }business-process-submitted.js"></sc' + 'ript>');
}
	</script>
