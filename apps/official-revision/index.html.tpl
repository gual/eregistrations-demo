...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }official-revision.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }official-revision.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }official-revision.js"></sc' + 'ript>');
}
	</script>
