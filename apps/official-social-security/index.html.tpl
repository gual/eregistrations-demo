...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }official-social-security.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }official-social-security.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }official-social-security.js"></sc' + 'ript>');
}
	</script>
