...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }business-process-demo.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }business-process-demo.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }business-process-demo.js"></sc' + 'ript>');
}
	</script>
