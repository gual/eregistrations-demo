...
var errorProps = ['location', 'message', 'source', 'line', 'column', 'errorMessage', 'errorStack'];

exports['log-client-error'] = {
	validate: function (data) {
		var normalizedData = {}, parsedData;
		parsedData = JSON.parse(data.data);
		errorProps.forEach(function (key) { normalizedData[key] = JSON.stringify(parsedData[key]); });
	...
	submit: function (normalizedData) {
		...
		data = normalizeOptions({ clientWithSessionId: this.req.$clientWithSessionId,
			...
			ip: this.req.connection.remoteAddress }, normalizedData);
