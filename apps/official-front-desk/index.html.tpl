...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }official-front-desk.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }official-front-desk.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }official-front-desk.js"></sc' + 'ript>');
}
	</script>
