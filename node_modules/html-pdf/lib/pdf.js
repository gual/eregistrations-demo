        ...
        if (code || stderr.length) {
          ...
          try {
            data = (ref = Buffer.concat(stdout).toString()) != null ? ref.trim() : void 0;
						if (!data) {
							// Temporary fix for: https://github.com/marcbachmann/node-html-pdf/issues/108
							console.log("PDF was rendered, still internal logic error occured. For more info see: https://github.com/marcbachmann/node-html-pdf/issues/108");
							console.log(this.options.phantomPath, [].concat(this.options.phantomArgs, [this.script]));
							console.log(this.html, this.options);
							data = {};
						} else {
