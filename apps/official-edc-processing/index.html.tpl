...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }official-edc-processing.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }official-edc-processing.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }official-edc-processing.js"></sc' + 'ript>');
}
	</script>
