...
var statusMap = require('../../apps/official-edc-processing/business-processes/map')
  , columns   = require('eregistrations/view/components/business-process-table-columns').columns;

var getOrderIndex =
	require('../../apps/official-edc-processing/business-processes/get-default-order-index');
