...
if (!Object.getPrototypeOf || !Object.defineProperty || !window.history ||
	...
	document.write('<link href="${ stRoot }business-process-final-test.css" rel="stylesheet" />');
	document.write('<scr' + 'ipt src="${ stRoot }business-process-final-test.legacy.js"></sc' + 'ript>');
	document.write('<scr' + 'ipt data-spa src="${ stRoot }business-process-final-test.js"></sc' + 'ript>');
}
	</script>
